...
public class SwaggerConfig {
	...
	@Bean
    OpenAPI springShapeFitOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto ShapeFit")
                .description("Projeto ShapeFit - Grupo MavenTech - Generation Brasil")
                .version("v0.0.1")
                .license(new License()
            ...
            .externalDocs(new ExternalDocumentation()
                .description("Github - Grupo MavenTech")
                .url("https://github.com/MavenTech83/shape_fit"));
